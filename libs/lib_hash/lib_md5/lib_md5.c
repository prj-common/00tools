...
void MD5_API MD5_Final
  (unsigned char digest[LIB_MD5_DIGEST_SIZE], 
   PMD5CTX pCtx ) 
{
...
static unsigned char selfTestDigest[3][LIB_MD5_DIGEST_SIZE] = 
{ 
...
int MD5_API MD5_SelfTest() 
{
    int nI, nJ;
    MD5CTX ctx;
    unsigned char actDigest[LIB_MD5_DIGEST_SIZE];
